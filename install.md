...
2. Install `vpm`: `sudo xbps-install vpm`
...
6. Install all your packages. (All done in the bash script). pulseaudio, ulauncher, neovim, flatpak, git, kitty, etc.
7. Copy dotfiles over (`~/.config` and `/etc`). 
