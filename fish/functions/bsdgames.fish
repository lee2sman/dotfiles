function bsdgames --description 'Dumps list of bsdgames I have installed and how to call them'
#
# List of bsdgames installed via brew/cask/bsdgames-osx
#
    ...
    wump - hunt the wumpus in an underground cave" | more
end
